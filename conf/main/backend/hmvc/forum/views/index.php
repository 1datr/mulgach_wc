...
$this->usewidget(new ListViewWidget($this),array('ds'=>$ds,
		'columns'=>array(
			'__default__',
			'edit'=>LVW_Column::ref_column('<a href="?r=forum/edit/{id}" role="button" class="btn btn-secondary btn-sm">#{EDIT}</a>'),
			'delete'=>LVW_Column::ref_column('<a href="?r=forum/delete/{id}" role="button" class="ref_delete btn btn-secondary btn-sm">#{DELETE}</a>'),
		)
));
