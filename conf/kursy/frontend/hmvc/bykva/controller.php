...
class BykvaController extends \AuthController
{
	...
	public function Rules()
	{
		return array(
			...
			'action_access'=>array(
						new \ActionAccessRule('deny',_array_diff($this->getActions(),array('login','auth','register','makeuser','regsuccess')),'anonym','bykva/login')
				),	
		);
	}
	...
	{
		$this->logout();
		$this->redirect(as_url('bykva/login'));
...
{
	$this->_MODEL->reguser($_POST['bykva']);
	$this->redirect(as_url('bykva/regsuccess'));
}
