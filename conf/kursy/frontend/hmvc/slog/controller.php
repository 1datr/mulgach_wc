...
class SlogController extends \AuthController
{
	...
	public function Rules()
	{
		return array(
			...
			'action_access'=>array(
						new \ActionAccessRule('deny',_array_diff($this->getActions(),array('login','auth','register','makeuser','regsuccess')),'anonym','slog/login')
				),	
		);
	}
	...
	{
		$this->logout();
		$this->redirect(as_url('slog/login'));
...
{
	$this->_MODEL->reguser($_POST['slog']);
	$this->redirect(as_url('slog/regsuccess'));
}
