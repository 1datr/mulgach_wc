...
class KursyController extends \AuthController
{
	...
	public function Rules()
	{
		return array(
			...
			'action_access'=>array(
						new \ActionAccessRule('deny',_array_diff($this->getActions(),array('login','auth','register','makeuser','regsuccess')),'anonym','kursy/login')
				),	
		);
	}
	...
	{
		$this->logout();
		$this->redirect(as_url('kursy/login'));
...
{
	$this->_MODEL->reguser($_POST['kursy']);
	$this->redirect(as_url('kursy/regsuccess'));
}
