...
?>
<input type="hidden" name="primeneniye[]" value="<?=((!empty($primeneniye)) ? $primeneniye->getField('') : '')?>" />
<h3><?php 
...
<table>
	...
	<tr>
	<th><label>#{primeneniye.id}</label></th><td>
				<input type="text" name="primeneniye[id]" value="<?=((!empty($primeneniye)) ? $primeneniye->getField('id',true) : '')?>" />
