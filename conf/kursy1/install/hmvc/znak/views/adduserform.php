<?php
$form = new mulForm(as_url('znak/regadmin'),$this);
...
<table>
	...
	<?php $form->field($reg_struct,'_re')->password();	 ?>	</td>
		...
		<tr>
	<th><label>#{.id_znak}</label></th><td>
	<?php $form->field($reg_struct,'id_znak')->text();	 ?>	</td>
	</tr>
		<tr>
	<th><label>#{.znak}</label></th><td>
	<?php $form->field($reg_struct,'znak')->text();	 ?>	</td>
	</tr>
		<tr>
