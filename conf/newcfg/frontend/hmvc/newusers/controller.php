...
class NewusersController extends \AuthController
{
	...
	public function Rules()
	{
		return array(
			...
			'action_access'=>array(
						new \ActionAccessRule('deny',_array_diff($this->getActions(),array('login','auth','register','makeuser','regsuccess')),'anonym','newusers/login')
				),	
		);
	}
...
{
	$this->_MODEL->reguser($_POST['newusers']);
	$this->redirect(as_url('newusers/regsuccess'));
}
